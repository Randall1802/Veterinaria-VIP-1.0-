...
namespace Veterinaria__VIP_1._0_
{
	public partial class ForoVIP : Form
	{
		...
		{
			PaginaVentas ventas = new PaginaVentas(user);
			this.Hide();
			ventas.Show();
			ventas.FormClosed += (s, args) => this.Close();
		}

		private void medicoToolStripMenuItem_Click(object sender, EventArgs e)
		{
			ServicioVeterinario medico = new ServicioVeterinario(user);
			this.Hide();
			medico.Show();
			medico.FormClosed += (s, args) => this.Close();
		}

		private void esteticoToolStripMenuItem_Click(object sender, EventArgs e)
		{
			ServicioEstetico estetico = new ServicioEstetico(user);
			this.Hide();
			estetico.Show();
			estetico.FormClosed += (s, args) => this.Close();
		}

		private void perfilDeMiMascotaToolStripMenuItem_Click(object sender, EventArgs e)
		{
			PaginaMascota mascota = new PaginaMascota(user);
			this.Hide();
			mascota.Show();
			mascota.FormClosed += (s, args) => this.Close();
		}
	}
}
